...
function Login() {
    ...
    return (
        <Layout>
             ...
             <form onSubmit={onFormSubmit} noValidate className="flex flex-col gap-3 rounded-lg p-4 bg-bash-600 w-96 h-[30rem]  shadow-[0_0_10px_black]">
             <p className="">
                            Don't have an account ? <Link to="/signup" className="cusror-pointer text-accent">Signup</Link>
                    </p>
                <h1 className="text-2xl text-center mt-12 font-bold">Login To Your Account</h1>
                  <p className=' font-semibold'>Please Login To Your Account , Thank You.</p>
                ...
                <button type="submit" className="btn btn-success text-lg font-semibold">
                   Log In
                </button>
