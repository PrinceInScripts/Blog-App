...
function EditBlog() {
    ...
    async function handleSubmit(e){
          ...
          const plainTextContent = parser.parseFromString(content, 'text/html').body.textContent;

          const response=await dispatch(editBlogDetails({ slug: state.slug, content: plainTextContent }))
        ...
        <Layout>
            <div className='min-h-[90vh] flex items-center justify-center'>
                <form onSubmit={handleSubmit} className='flex flex-col gap-10'>
                    ...
                    <button type='submit' className='btn btn-info'>Edit Content</button>
                </form>
