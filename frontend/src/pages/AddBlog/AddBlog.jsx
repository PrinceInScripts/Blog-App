...
function AddBlog() {
  ...
  async function onFormSubmit(e) {
    ...
    const plainTextContent = parser.parseFromString(userInput.content, 'text/html').body.textContent;
  ...
  return (
    <Layout>
      ...
      <div className="min-h-[100vh] flex items-center justify-center">
                ...
                >
                     <Link onClick={()=>navigate(-1)} className="absolute top-20 text-2xl link text-accent cursor-pointer">
                  <AiOutlineArrowLeft/>
                  </Link>
